...
#        $PROTOC --proto_path=${dirName} --proto_path=. --go_out=plugins=grpc:../${pb_package}/${dirName}  --go_opt=paths=source_relative $proto_file
        $PROTOC --proto_path=${dirName} --proto_path=. --go_out=plugins=grpc:../${pb_package}/${dirName}  --go_opt=paths=source_relative $proto_file --plugin=protoc-gen-go=../../bin/protoc-gen-go
